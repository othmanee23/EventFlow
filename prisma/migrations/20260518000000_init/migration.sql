...
-- CreateEnum
CREATE TYPE "TaskCategory" AS ENUM ('EVENT_PREPARATION', 'PARTICIPANTS', 'COMMUNICATION', 'LOGISTICS', 'AUDIOVISUAL_PRODUCTION', 'POST_EVENT');
...
-- CreateIndex
CREATE INDEX "Project_eventDate_idx" ON "Project"("eventDate");
